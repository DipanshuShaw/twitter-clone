...
function Navbar() {
  return (
    <div>
      <div
            className="inline-block h-screen p-2 pt-4 overflow-y-scroll border-0 border-r-2 first lg:w-72 border-zinc-700 mix-blend-normal no-scrollbar">
            <div className="">
                ...
                <ul>
                    <li className="mb-6 text-center lg:text-left"><a href="#"
                            className="w-auto p-2 px-4 text-xl rounded-full hover:bg-gray-300 hover:bg-opacity-15"><i
                                className="fa-lg fa-solid fa-house"></i><span className="hidden px-4 lg:inline">Home</span></a>
                    </li>
                    <li className="mb-6 text-center lg:text-left"><a href="#"
                            className="w-auto p-2 px-4 text-xl rounded-full hover:bg-gray-300 hover:bg-opacity-15"><i
                                className="fa-lg fa fa-search" aria-hidden="true"></i><span
                                className="hidden px-4 lg:inline">Explore</span></a></li>
                    <li className="mb-6 text-center lg:text-left"><a href="#"
                            className="w-auto p-2 px-4 text-xl rounded-full hover:bg-gray-300 hover:bg-opacity-15"><i
                                className="fa-lg fa fa-bell" aria-hidden="true"></i><span
                                className="hidden px-4 lg:inline">Notifications</span></a></li>
                    <li className="mb-6 text-center lg:text-left"><a href="#"
                            className="w-auto p-2 px-4 text-xl rounded-full hover:bg-gray-300 hover:bg-opacity-15"><i
                                className="fa-lg fa fa-envelope-o" aria-hidden="true"></i><span
                                className="hidden px-4 lg:inline">Messages</span></a></li>
                    <li className="mb-6 text-center lg:text-left"><a href="#"
                            className="w-auto p-2 px-4 text-xl rounded-full hover:bg-gray-300 hover:bg-opacity-15"><i
                                className="fa-solid fa-at"></i><span className="hidden px-4 lg:inline">Mentions</span></a></li>
                    <li className="mb-6 text-center lg:text-left"><a href="#"
                            className="w-auto p-2 px-4 text-xl rounded-full hover:bg-gray-300 hover:bg-opacity-15"><i
                                className="fa-lg fa-regular fa-rectangle-list"></i><span
                                className="hidden px-4 lg:inline">Lists</span></a></li>
                    <li className="mb-6 text-center lg:text-left"><a href="#"
                            className="w-auto p-2 px-4 text-xl rounded-full hover:bg-gray-300 hover:bg-opacity-15"><i
                                className="fa-lg fa fa-bookmark-o" aria-hidden="true"></i><span
                                className="hidden px-4 lg:inline">Bookmarks</span></a></li>
                    <li className="mb-6 text-center lg:text-left"><a href="#"
                            className="w-auto p-2 px-4 text-xl rounded-full hover:bg-gray-300 hover:bg-opacity-15"><i
                                className="fa-lg fa-solid fa-user-group"></i><span
                                className="hidden px-4 lg:inline">Communities</span></a></li>
                    <li className="mb-6 text-center lg:text-left"><a href="#"
                            className="w-auto p-2 px-4 text-xl rounded-full hover:bg-gray-300 hover:bg-opacity-15"><i
                                className="fa-lg fa-brands fa-x-twitter"></i><span
                                className="hidden px-4 lg:inline">Premium</span></a></li>
                    <li className="mb-6 text-center lg:text-left"><a href="#"
                            className="w-auto p-2 px-4 text-xl rounded-full hover:bg-gray-300 hover:bg-opacity-15"><i
                                className="fa-lg fa-regular fa-user"></i><span
                                className="hidden px-4 lg:inline">Profile</span></a></li>
                    <li className="mb-4 text-center lg:text-left"><a href="#"
                            className="w-auto p-2 px-4 text-xl rounded-full hover:bg-gray-300 hover:bg-opacity-15"><i
                                className="fa-lg fa-solid fa-ellipsis"></i><span
                                className="hidden px-4 lg:inline">More</span></a></li>
                </ul>
            </nav>
